      ...
      {loading ? <Spinner/> : report && (
        <div className="space-y-5">
          ...
          {report.methodBreakdown.length > 0 && (
            <div className="card overflow-hidden p-0">
              <div className="px-5 py-3 bg-gray-50 border-b"><h3 className="text-sm font-semibold text-gray-700">By Payment Method</h3></div>
              <table className="data-table">
                <thead><tr><th>Method</th><th className="text-right">Transactions</th><th className="text-right">Total</th></tr></thead>
                <tbody>
